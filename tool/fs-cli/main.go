...
import (
	...
	"github.com/sky0621/try-goa/client"
	"github.com/sky0621/try-goa/tool/cli"
...
func main() {
	...
	app := &cobra.Command{
		Use:   "fs-cli",
		Short: `CLI client for the fs service`,
	}
	...
	app.PersistentFlags().StringVarP(&c.Host, "host", "H", "localhost:8585", "API hostname")
